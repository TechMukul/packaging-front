  ...
  return (
    <footer className={styles.footer}>
      <div className={styles.footerleft}>
        ...
        <div className={styles.socialLinks}>
          ...
          <a href="https://www.youtube.com/youryoutubelink" className={styles.socialIcon} target="_blank" rel="noopener noreferrer">
            <div className={styles.socialIconWrapper}>
              <Image src={you} alt="YouTube" width={40} height={30} />
            </div>
          </a>
        </div>
      </div>
      ...
      <h1 className={styles.quickLinksHeading}>Certifications</h1>
        ...
        <Image src={"https://img.freepik.com/premium-vector/iso-9001-2015-certification-iso-90012015-logo-iso-9000-certification_526569-642.jpg?size=338&ext=jpg&ga=GA1.1.1546980028.1719619200&semt=ais_user"} alt="pic" width={130} height={100}></Image>
